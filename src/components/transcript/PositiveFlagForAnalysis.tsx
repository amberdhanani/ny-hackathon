...
const PositiveFlagForAnalysis = ({ entry }: Props) => {
  return (
    <>
      <div
        style={{
      ...
      >
        ...
        <span style={{ fontSize: "14px", fontWeight: "600" }}>Growth mindset language</span>
      </div>
      ...
      {entry.flagDetails && (
        <>
          ...
          <h4 style={{ color: "#222", fontWeight: "600", marginTop: "24px" }}>
            WHY WAS THIS A GREAT EXAMPLE OF GROWTH MINDSET?
          </h4>
...
export default PositiveFlagForAnalysis;
